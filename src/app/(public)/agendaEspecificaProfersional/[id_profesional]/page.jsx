...
const WEEKDAY_START_MINUTES = (9 * 60) + 30;
const WEEKDAY_END_MINUTES = (18 * 60) + 15;
const SATURDAY_START_MINUTES = 10 * 60;
const SATURDAY_END_MINUTES = 12 * 60;
...
export default function CalendarioMensualHoras() {
    ...
    // Genera bloques de 15 minutos según el día de la semana.
    // Lunes a Viernes: 09:30 - 18:15
    // Sábado: 10:00 - 12:00
    ...
    const attentionSlots = useMemo(() => {
        ...
        const startMinutes = isSaturday ? SATURDAY_START_MINUTES : WEEKDAY_START_MINUTES;
        const endMinutes = isSaturday ? SATURDAY_END_MINUTES : WEEKDAY_END_MINUTES;
        ...
        while (cursor + SLOT_DURATION_MINUTES <= endMinutes) {
            ...
            const attEnd = cursor + SLOT_DURATION_MINUTES;
    ...
    const seleccionarFecha = (fecha) => {
        ...
        if (horaInicio) {
            const horaFinAuto = addMinutesToHHMM(horaInicio, SLOT_DURATION_MINUTES);
    ...
    const seleccionarInicio = (hora) => {
        ...
        const horaFinAuto = addMinutesToHHMM(hora, SLOT_DURATION_MINUTES);
            ...
            <div className="mx-auto w-full max-w-3xl">
                <header className="mb-6 flex flex-col items-center gap-2 text-center">
                    ...
                    <p className="max-w-md text-sm leading-6 text-slate-500">
                        Reserva tu hora oftalmológica en segundos. Selecciona fecha y un bloque horario disponible.
                    </p>
                </header>
                        ...
                        <div className="mt-5">
                            <div className="flex items-center justify-between">
                                <h3 className="text-sm font-semibold text-slate-800">
                                    Agenda ({fechaSeleccionada?.getDay() === 6 ? "10:00-12:00" : "09:30-18:15"})
                                </h3>
                                <div className="flex items-center gap-3">
                                    <p className="text-xs text-slate-500">Bloques de 15 min</p>
                                    {checkingBlocked && (
                ...
                <footer className="mt-10 text-center text-xs text-slate-600">
                    <p>
                        Oftalmología clínica integral con atención personalizada para cada paciente.
                    </p>
                    <p className="mt-2 text-[11px] text-slate-400">
                        Horarios: Lun-Vie 09:30-18:15 | Sáb 10:00-12:00 | Dom Cerrado
                    </p>
                </footer>
            </div>
        </div>
